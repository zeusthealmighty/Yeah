...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("GoSuperSayayinCoin Core GoSuperSayayinCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  GoSuperSayayinCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded GoSuperSayayinCoin transaction") + "\n" +
              "  GoSuperSayayinCoin-tx [options] -create [commands]   " + _("Create hex-encoded GoSuperSayayinCoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded GoSuperSayayinCoin transaction
