...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all GoSuperSayayinCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat GoSuperSayayinCoin and make it unusable. To
...
void ThreadCheckPrivateSendServer(CConnman& connman)
{
    ...
    RenameThread("GoSuperSayayinCoin-ps-server");
