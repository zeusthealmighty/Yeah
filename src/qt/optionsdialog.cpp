    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GSS-light"), QVariant("light"));
    ui->theme->addItem(QString("GSS-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("GSS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GSS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GSS-traditional"), QVariant("trad"));
