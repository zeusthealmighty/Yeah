    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("GoSuperSayayinCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GoSuperSayayinCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and GoSuperSayayinCoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About GoSuperSayayinCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about GoSuperSayayinCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GoSuperSayayinCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GoSuperSayayinCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GoSuperSayayinCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a GoSuperSayayinCoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GoSuperSayayinCoin Core help message to get a list with possible GoSuperSayayinCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("GoSuperSayayinCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GoSuperSayayinCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("GoSuperSayayinCoin Core"); // default title
    ...
    // Append title to "GoSuperSayayinCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
