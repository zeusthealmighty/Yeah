 ...
 *
 *   // network
 *   CGoSuperSayayinCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.GoSuperSayayinCoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGoSuperSayayinCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CGoSuperSayayinCoinNetwork(UniValue objIn)
    {
...
// // can be under: GoSuperSayayinCoinNetwork
// //   -- signature requirements : Key1(User)
// class CGoSuperSayayinCoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == GoSuperSayayinCoinNetwork);
//     // }
