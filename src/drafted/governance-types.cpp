...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GoSuperSayayinCoinNetwork") type = GoSuperSayayinCoinNetwork;
    if(strType == "GoSuperSayayinCoinNetworkVariable") type = GoSuperSayayinCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GoSuperSayayinCoinNetwork) s = "GoSuperSayayinCoinNetwork";
    if(type == GoSuperSayayinCoinNetworkVariable) s = "GoSuperSayayinCoinNetworkVariable";
