...
This mechanism has been integrated into Bitcore-Node-GoSuperSayayinCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GoSuperSayayinCoinpay/insight-api-GoSuperSayayinCoin#web-socket-api](https://github.com/GoSuperSayayinCoinpay/insight-api-GoSuperSayayinCoin#web-socket-api)
* API: [https://github.com/GoSuperSayayinCoinpay/insight-api-GoSuperSayayinCoin#instantsend-transactions](https://github.com/GoSuperSayayinCoinpay/insight-api-GoSuperSayayinCoin#instantsend-transactions)
...
By default, the GoSuperSayayinCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GoSuperSayayinCoin Core daemon:
