...
GoSuperSayayinCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as GoSuperSayayinCoin Core, where everyone uses
...
pay attention to for reviewers of GoSuperSayayinCoin Core code.

General GoSuperSayayinCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: GoSuperSayayinCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
